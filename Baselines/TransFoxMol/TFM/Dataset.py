...
class MolNet(InMemoryDataset):
    def __init__(self, root='dataset', dataset=None, xd=None, y=None, transform=None, pre_transform=None, smile_graph=None, processed_file_name=None):
        # root is required for save raw data and preprocessed data
        super(MolNet, self).__init__(root, transform, pre_transform)
        self.dataset = dataset
        self.pfn = processed_file_name
