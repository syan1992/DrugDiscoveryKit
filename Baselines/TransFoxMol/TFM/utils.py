...
def load_data(dataset, batch_size, cpus_per_gpu, fold=1):
    trainset = MolNet(root='./dataset', dataset=dataset, processed_file_name = 'train_' + dataset + '_' + str(fold) + '_pyg.pt')
    validset = MolNet(root='./dataset', dataset=dataset, processed_file_name = 'valid_' + dataset + '_' + str(fold) + '_pyg.pt')
    testset = MolNet(root='./dataset', dataset=dataset, processed_file_name = 'test_' + dataset + '_' + str(fold) + '_pyg.pt')
    '''
